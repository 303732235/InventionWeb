<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PolicyDetails.aspx.cs"
    Inherits="InventionWeb.Front.Policy.PolicyDetails" %>
...
<body>
    ...
    <div class="content">
        <br />
        <span class="title">当前位置：<a href="default.aspx" target="_self">创新理论</a>>>正文</span>
        <br />
        <asp:ListView ID="ListViewPolicy" runat="server">
            <ItemTemplate>
                <table>
                    <tr>
