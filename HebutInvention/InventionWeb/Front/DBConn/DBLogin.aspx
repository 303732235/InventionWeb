<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DBLogin.aspx.cs" Inherits="InventionWeb.Front.DBConn.DBLogin" %>
                        ...
                        <td height="561" style="background: url(../../images/background-login2/lbg.gif)">
                            <table width="940" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <center style="font-size:36px;font-weight:bold;color:#06AEEF;">动态修改连接字符串</center>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="190">
                                                    ...
                                                    <table width="320" border="0" align="center" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td height="30">
                                                                ...
                                                                <img src="../picture2.aspx" id="captchaimg" style="cursor: pointer; margin-left: 5px"
                                                                    onclick="this.src='../picture2.aspx?'+Math.random()" align="absmiddle" title="看不清？点击更换验证码" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td height="30">
