<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExampleRight.aspx.cs" Inherits="InventionWeb.Front.Example.ExampleRight" %>
...
<body>
    ...
    <div>
    <br /><br />
    <span class="ModuleName">河北工业大学学报通知公告</span>
            ...
            <ItemTemplate>
                <table class="RightTable" cellspacing="7px";cellpadding="0">
                    <tr>
                        ...
                        <td>
                            <a href="./ExampleDetails.aspx?id=<%#Eval("id")%>" target="_parent">
                                <%#Eval("title")%></a>
                        </td>
