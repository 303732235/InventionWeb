<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeRight.aspx.cs" Inherits="InventionWeb.Front.Notice.NoticeRight" %>
...
<body>
    ...
    <div>
        <br />
        <br />
        <span class="ModuleName">综合通知</span> <span class="Search">
            ...
            <ItemTemplate>
                <table class="RightTable" cellspacing="7px" cellpadding="0">
                    <tr>
                        ...
                        <td>
                            <a href="./NoticeDetails.aspx?id=<%#Eval("id")%>" target="_parent">
                                <%#Eval("title")%></a>
                        </td>
