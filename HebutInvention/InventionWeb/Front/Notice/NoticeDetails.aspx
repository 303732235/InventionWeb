<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeDetails.aspx.cs"
    Inherits="InventionWeb.Front.Notice.NoticeDetails" %>
...
<body>
    ...
    <div class="content">
        <br />
        <span class="title">当前位置：<a href="default.aspx" target="_self">通知通告</a>>>正文</span>
        <br /><br />
        <asp:ListView ID="ListViewNotice" runat="server">
            <ItemTemplate>
                <table>
                    <tr>
