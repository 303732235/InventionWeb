<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkdtRight.aspx.cs" Inherits="InventionWeb.Front.Workdt.WorkdtRight" %>
...
<body>
    ...
    <div>
        <br />
        <br />
        <span class="ModuleName">河北工业大学学报（社会科学版）通知公告</span> <span class="Search">
            ...
            <ItemTemplate>
                <table class="RightTable" cellspacing="7px" cellpadding="0">
                    <tr>
                        ...
                        <td>
                            <a href="./WorkdtDetails.aspx?id=<%#Eval("id")%>" target="_parent">
                                <%#Eval("title")%></a>
                        </td>
