<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="InventionWeb.Front.Workdt._default" %>
            ...
            <tr>
                ...
                <td class="right-mid">
                    <iframe id="mainFrame" name="mainFrame" marginwidth="0" marginheight="3" frameborder="0"
                        width="95%" src="WorkdtRight.aspx" scrolling="yes" height="440px" runat="server">
                    </iframe>
                </td>
            </tr>
         </table>
