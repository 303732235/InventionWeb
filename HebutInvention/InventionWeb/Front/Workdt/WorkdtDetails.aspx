<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkdtDetails.aspx.cs"
    Inherits="InventionWeb.Front.Workdt.PolicyDetails" %>
...
<head id="Head1" runat="server">
    <title>河北工业大学学报（社会科学版）通知公告</title>
...
<body onload="size()">
    ...
    <div class="content">
        <br />
        <span class="title">当前位置：<a href="../Notice/default.aspx" target="_self">河北工业大学学报（社会科学版）通知公告</a>>>正文</span>
        <br /><br />
        <asp:ListView ID="ListViewWorkdt" runat="server">
            <ItemTemplate>
                <table>
                    <tr>
