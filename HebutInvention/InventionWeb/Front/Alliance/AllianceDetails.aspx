<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllianceDetails.aspx.cs"
    Inherits="InventionWeb.Front.Alliance.AllianceDetails" %>
...
<head id="Head1" runat="server">
    <title>河北工业大学学报（社会科学版）投稿指南</title>
...
<body>
    ...
    <div class="content">
        <br />
        <span class="title">当前位置：<a href="../News/default.aspx" target="_self">河北工业大学学报（社会科学版）投稿指南</a>>正文</span>
        <br />
        <br />
