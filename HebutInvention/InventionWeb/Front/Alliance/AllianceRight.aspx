<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllianceRight.aspx.cs" Inherits="InventionWeb.Front.Alliance.AllianceRight" %>
...
<body>
    ...
    <div>
    <br /><br />
    <span class="ModuleName">河北工业大学学报（社会科学版）投稿指南</span>
            ...
            <ItemTemplate>
                <table  class="RightTable" cellspacing="7px" cellpadding="0">
                    <tr>
                        ...
                        <td>
                            <a href="./AllianceDetails.aspx?id=<%#Eval("id")%>" target="_parent">
                                <%#Eval("title")%></a>
                        </td>
