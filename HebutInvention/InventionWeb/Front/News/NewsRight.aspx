<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsRight.aspx.cs" Inherits="InventionWeb.Front.News.NewsRight"%>
...
<body>
    ...
    <div>
    <br /><br />
   <span class="ModuleName">河北工业大学学报投稿指南</span>
    <span class="Search" style = "display:none">
          <asp:TextBox ID="txtKwords" runat="server" Width="125"></asp:TextBox>
            ...
            <ItemTemplate>
                <table class="RightTable" cellspacing="7px";cellpadding="0">
                    <tr>
                        ...
                        <td>
                            <a href="./NewsDetails.aspx?id=<%#Eval("id")%>" target="_parent">
                                <%#Eval("title")%></a>
                        </td>
