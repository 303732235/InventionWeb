<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RightMgr.aspx.cs" Inherits="InventionWeb.Background.ImageRight.RightMgr" %>
        ...
        <ItemTemplate>
            <table cellspacing="0" cellpadding="0" width="950px" class="tabcenter">
                <tr>
                    ...
                    <td width="100" class="tabtd">
                       <a href='RightEdit.aspx?id=<%# Eval("id")%>'>修改</a>
