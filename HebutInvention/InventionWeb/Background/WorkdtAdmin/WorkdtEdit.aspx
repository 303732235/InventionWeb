<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkdtEdit.aspx.cs" Inherits="InventionWeb.Background.WorkdtAdmin.WorkdtEdit"
    ...
    <div  class="content">
        <table width="100%">
            ...
            <tr>
                ...
                <td class="EditPicMiddle">
                    <asp:Button ID="Add" runat="server" Text="提交" OnClick="Save_Click" OnClientClick="return workdtnull()" />
