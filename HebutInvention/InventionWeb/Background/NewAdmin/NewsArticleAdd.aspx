<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsArticleAdd.aspx.cs"
    Inherits="NewsManager.NewsArticleAdd" ValidateRequest="false" %>
    ...
    <div class="content">
        <table width="100%">
            ...
            <tr>
                ...
                <td class="Publishright">
                    <asp:Button ID="Add" runat="server" Text="提交" OnClick="Button1_Click" OnClientClick="return notnull()" />
