<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsEdit.aspx.cs" ValidateRequest="false"
    Inherits="InventionWeb.Background.NewAdmin.NewsEdit" %>
    ...
    <div class="content" >
        <table width="100%">
            ...
            <tr>
                ...
                <td class="Publishright">
                    <asp:TextBox ID="txtTime" runat="server" onClick="javascript:ShowCalendar(this.id)"></asp:TextBox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="Publishright">
                    <asp:Button ID="Button1" runat="server" Text="提交" OnClick="Button1_Click" OnClientClick="return notnull()" />
