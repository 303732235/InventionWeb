...
{
    public partial class AllianceManager : System.Web.UI.Page
    {
        ...
        public void DateBind()
        {
            ...
            IList<AllianceArticle> allianceart = alliancearticlebll.Getlist(null);
            if (allianceart == null) {
                return;
            }
            ps.DataSource = allianceart;
        ...
        protected void Delete_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < DataList1.Items.Count; i++)
            {
                if (((CheckBox)DataList1.Items[i].FindControl("selected")).Checked == true)
                {
                    ...
                    if (alliancearticlebll.Delete(s))
                    {
        ...
        protected void DataList1_DeleteCommand(object sender, DataListCommandEventArgs e)
        {
            ...
            if (alliancearticlebll.Delete(id))
            {
