<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="AllianceArticleAdd.aspx.cs"
    Inherits="InventionWeb.Background.AllianceAdmin.AllianceArticleAdd" %>
    ...
    <div class="content">
        <table width="100%">
            ...
            <tr>
                ...
                <td class="Publishright">
                    <asp:Button ID="Add" runat="server" Text="添加" OnClick="Add_Click" OnClientClick="return alliancenull()" />
