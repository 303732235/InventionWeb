<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="AllianceEdit.aspx.cs"
    Inherits="InventionWeb.Background.AllianceAdmin.AllianceEdit" %>
    ...
    <div class="content">
        <table width="100%">
            ...
            <tr>
                ...
                <td class="Publishright">
                    <asp:Button ID="Add" runat="server" Text="提交" OnClick="Save_Click"  OnClientClick="return alliancenull()" />
