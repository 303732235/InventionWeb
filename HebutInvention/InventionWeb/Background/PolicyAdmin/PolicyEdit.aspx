<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PolicyEdit.aspx.cs" Inherits="InventionWeb.Background.PolicyAdmin.PolicyEdit"
    ...
    <div class="content">
        <table width="100%">
            ...
            <tr>
                ...
                <td class="Publishright">
                    <asp:Button ID="Add" runat="server" Text="提交" OnClick="Save_Click" OnClientClick="return policynull()" />
