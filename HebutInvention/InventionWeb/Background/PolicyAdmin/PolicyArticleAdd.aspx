<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PolicyArticleAdd.aspx.cs"
    Inherits="InventionWeb.Background.PolicyAdmin.PolicyArticleAdd" ValidateRequest="false" %>
    ...
    <div class="content">
        <table width="100%" >
            ...
            <tr>
                ...
                <td class="Publishright">
                    <asp:Button ID="Add" runat="server" Text="提交" OnClick="Add_Click" OnClientClick="return policynull()" />
