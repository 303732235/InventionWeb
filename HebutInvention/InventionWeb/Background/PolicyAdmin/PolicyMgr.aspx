<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PolicyMgr.aspx.cs" Inherits="InventionWeb.Background.PolicyAdmin.PolicyMgr"
    ...
    <div class="content">
        <asp:DataList ID="DataList1" runat="server" Width="950px" CellPadding="0" CellSpacing="0"
            ...
            <HeaderTemplate>
                ...
                <table width="950" cellspacing="0" cellpadding="0" class="tabcenter">
            </HeaderTemplate>
            <ItemTemplate>
                <tr class="tabtr">
                    ...
                    <td width="100" class="tabtd">
                        <a href='PolicyEdit.aspx?id=<%# Eval("id")%>'>修改</a>
