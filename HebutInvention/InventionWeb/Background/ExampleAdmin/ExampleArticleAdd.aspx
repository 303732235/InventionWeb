<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="ExampleArticleAdd.aspx.cs"
    Inherits="InventionWeb.Background.ExampleAdmin.ExampleArticleAdd" %>
    ...
    <div class="content">
        <table width="100%">
            ...
            <tr>
                ...
                <td class="Publishright">
                    <asp:Button ID="Add" runat="server" Text="提交" OnClick="Add_Click" OnClientClick="return examplenull()" />
