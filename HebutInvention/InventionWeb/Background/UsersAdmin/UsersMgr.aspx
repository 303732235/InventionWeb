<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsersMgr.aspx.cs" Inherits="InventionWeb.Background.UsersAdmin.UsersMgr" %>
...
<body style="background-color: #d6e4ef">
    ...
    <div class="content">
        <asp:DataList ID="DataList1" runat="server" Width="950px" CellPadding="0" CellSpacing="0"
            ...
            <HeaderTemplate>
                <table id="tab1" cellpadding="0" cellspacing="0" class="tabtitle">
                    <tr>
                        <td width="55">
                            选择框
                        </td>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td width="200" class="tabtd">
                     &nbsp;   <%# DataBinder.Eval(Container.DataItem, "UserEmail").ToString()%>
                    </td>
                   
                    <td width="150" class="tabtd">
                       &nbsp;  <%#Eval("UserAddress").ToString()%>
                    </td>
                    <td width="100" class="tabtd">
                       &nbsp; 
                    ...
                    <td width="100" class="tabtd">
                        <a href='UsersEdit.aspx?id=<%# Eval("UserID")%>'>修改</a>
                        <asp:LinkButton ID="del" CommandName="Delete" OnClientClick="return confirm('确定要删除？')"
                            CommandArgument='<%# DataBinder.Eval(Container.DataItem,"UserID")%>' runat="server">删除</asp:LinkButton>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
